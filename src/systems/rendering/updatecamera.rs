...
impl<'a> System<'a> for UpdateCamera
{
    ...
    type SystemData = (WriteExpect<'a,Camera>,WriteExpect<'a,CameraController>,ReadExpect<'a,DeltaTime>);

    fn run(&mut self, (mut camera,mut cam_controller,delta_time): Self::SystemData) {
        ...
        //zoom -  not working as no scroll event is being handled.
